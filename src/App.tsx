...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (savedToken) login(savedToken, isDemo);
  }, []);
  ...
  useEffect(() => {
    ...
    return () => { unsubTick(); unsubAuth(); unsubPOC(); unsubBalance(); };
  }, [timeframe]);
        ...
        <div className="w-full max-w-md space-y-8 animate-in fade-in zoom-in duration-500">
          ...
          <NeonCard variant="purple" className="p-8 space-y-6">
            <div className="space-y-4">
              ...
              <Button onClick={() => login(token, isDemo)} disabled={!token}
  ...
  return (
    <div className="flex min-h-screen bg-[#0a0a0c] text-slate-200 font-sans selection:bg-purple-500/30">
      <div className="hidden lg:block">
        <Sidebar onLogout={logout} activeTab={activeTab} setActiveTab={setActiveTab} />
      </div>
        ...
        <div className="lg:hidden px-6 py-3 border-b border-white/5 flex items-center justify-between bg-black/40">
          <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
            ...
            <SheetContent side="left" className="p-0 w-64 bg-[#0a0a0c] border-r border-white/10">
              <Sidebar onLogout={logout} activeTab={activeTab} setActiveTab={setActiveTab} closeMobile={() => setIsMobileMenuOpen(false)} />
            </SheetContent>
          </Sheet>
              ...
              <>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
                  ...
                  <NeonCard variant="blue" className="p-3 md:p-4 flex flex-col justify-between h-24 md:h-32">
                    ...
                    <h2 className={cn("text-sm md:text-xl font-black tracking-tighter", stats.totalProfit >= 0 ? "text-blue-400" : "text-red-400")}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
                  <div className="lg:col-span-2 space-y-6 md:space-y-8">
                    ...
                    {/* Zero props — BotControls lê tudo das stores */}
                    <BotControls />
                  </div>
